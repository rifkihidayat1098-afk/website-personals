...
$id_news = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
<html lang="id">
  <head>
    ...
    <title>Detail Berita - SMAN 2 SIMEULUE BAR</title>
  ...
  <body>
    ...
    <main>
        <div class="container-detail">
            <?php if ($berita): ?>
                <img src="../assets/img/g1.png" alt="image berita">
            <h1>
                <?= htmlspecialchars($berita['news_title']) ?>
            </h1>
            <div class="date"><?= date('d M Y', strtotime($berita['news_datestamp'])) ?>
            </div>
            <div class="content"><?= nl2br(htmlspecialchars($berita['news_content'])) ?></div>
            <?php else: ?>
            <p>Berita tidak ditemukan.</p>
            <?php endif; ?>
            <a href="index.php" class="back-link">&larr; Kembali ke daftar berita</a>
        </div>
    </main>
