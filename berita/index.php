...
$berita = [];
$queryBerita = mysqli_query($koneksi, "SELECT * FROM news ORDER BY news_datestamp DESC");
...
<html lang="id">
  <head>
    ...
    <title>Berita - SMAN 2 SIMEULUE BAR</title>
                ...
                <div class="card-container">
                    <?php if (count($berita) > 0): ?>
                        <?php foreach ($berita as $item): ?>
                            <div class="card">
                                <a href="detail.php?id=<?= $item['id_news'] ?>" class="card-berita">
                                    <img src="../assets/img/g1.png" alt="">
                                    <h3><?= htmlspecialchars($item['news_title']) ?></h3>
                                    <p><?= htmlspecialchars(substr($item['news_content'], 0, 80)) ?>...</p>
                                    <small><?= date('d M Y', strtotime($item['news_datestamp'])) ?></small>
                                </a>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
